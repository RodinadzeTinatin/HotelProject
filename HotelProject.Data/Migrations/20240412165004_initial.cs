    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Tbilisi", "Georgia", "First hotel", "raghac adgili", 10.0 },
                    { 2, "Batumi", "Georgia", "Second hotel", "raghac raghac adgili", 3.0 },
                    { 3, "Batumi", "Georgia", "Third hotel", "raghac raghac adgili", 10.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vighac", 1, "Vighacasvhili" },
                    { 2, "Irving", 2, "Stone" },
                    { 3, "Tinatin", 3, "Rodinadze" }
                });
